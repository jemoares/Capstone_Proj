...
>
  <head>
    ...
    <title>Login Page | Quezon City</title>
              ...
              <div class="mb-3 text-center">
                      ...
                      <div class="dropdown text-center">
                        ...
                        <ul class="dropdown-menu dropdown-menu-start ms-2 px-4 text-center dropdown-menu-light">
                          <li><a class="dropdown-item" href={{ '/Health_Department/Login' }}>Health Department</a></li>
                          <li><a class="dropdown-item" href={{ '/District/Login' }}>District</a></li>
                          <li><a class="dropdown-item" href={{ '/Health_Center/Login' }}>Health Center</a></li>
                          <li><a class="dropdown-item" href={{ '/Program_Manager/Login' }}>Program Manager</a></li>
