                                        ...
                                        <div class="col-lg-8 mb-4 order-0">
                                            <div class="card">
                                                <div class="d-flex align-items-end row">
                                                    <div class="col-sm-7">
                                                        <div class="card-body">
                                                            <h5 class="card-title text-primary">Welcome to Admin
                                                                Dashboard John! 🎉</h5>
                                                            <p class="mb-4">
                                                                You have done <span class="fw-bold"></span> Lorem ipsum
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div
                                                                ...
                                                                <div class="dropdown">
                                                                    <button class="btn p-0" type="button"
                                                                        id="cardOpt4" data-bs-toggle="dropdown"
                                                                        aria-haspopup="true" aria-expanded="false">
                                                                        <i class="bx bx-dots-vertical-rounded"></i>
                                                                    </button>
                                                                    <div class="dropdown-menu dropdown-menu-end"
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div
                                                                ...
                                                                <div class="dropdown">
                                                                    <button class="btn p-0" type="button"
                                                                        id="cardOpt1" data-bs-toggle="dropdown"
                                                                        aria-haspopup="true" aria-expanded="false">
                                                                        <i class="bx bx-dots-vertical-rounded"></i>
                                                                    </button>
                                                            ...
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="card-title">
                                                                        ...
                                                                        <span
                                                                            class="badge bg-label-warning rounded-pill">Year
                                                                            2021</span>
                                                                    </div>
                                                                    <div class="mt-sm-auto">
                                                                        <small
                                                                            class="text-success text-nowrap fw-semibold"><i
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="p-0 m-0">
                                                        ...
                                                        <li class="d-flex">
                                                            <div class="avatar flex-shrink-0 me-3">
                                                                <span
                                                                    class="avatar-initial rounded bg-label-secondary"><i
                                                    ...
                                                    <ul class="p-0 m-0">
                                                        <li class="d-flex mb-4 pb-1">
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="me-2">
                                                                    <small
                                                                        class="text-muted d-block mb-1">Title</small>
                                                                    <h6 class="mb-0">Title</h6>
                                                                </div>
                                                                <div
